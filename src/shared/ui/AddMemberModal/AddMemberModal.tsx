...
export interface IAddMemberModalModel {
  isOpen: boolean
  ...
  createAndAddUser(): Promise<void>
}

interface AddMemberModalProps {
  model: IAddMemberModalModel
  title: string
  roleSelect: ReactNode
}

export const AddMemberModal: FC<AddMemberModalProps> = observer(({ model, title, roleSelect }) => {
  return (
