...
| --------------------- | -------------------------- | ------------------- | -------------------- | --------------------------------- |
| Google OAuth callback | Google OAuth configuration | Provider enabled    | Provider disabled    | Callback route can complete login |
...
- Requires Google OAuth provider configuration.
