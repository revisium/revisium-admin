...
export type UserFragment = { id: string, username?: string | null, email?: string | null, hasPassword: boolean, organizationId?: string | null, role?: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } | null };

export type GetMeQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMeQuery = { me: { id: string, username?: string | null, email?: string | null, hasPassword: boolean, organizationId?: string | null, role?: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } | null } };
...
export type TableViewsDataFragment = { version: number, defaultViewId: string, views: Array<{ id: string, name: string, description?: string | null, filters?: { [key: string]: any } | string | number | boolean | null | null, search?: string | null, columns?: Array<{ field: string, width?: number | null }> | null, sorts?: Array<{ field: string, direction: string }> | null }> };
...
export type GetTableViewsQuery = { table?: { id: string, views: { version: number, defaultViewId: string, views: Array<{ id: string, name: string, description?: string | null, filters?: { [key: string]: any } | string | number | boolean | null | null, search?: string | null, columns?: Array<{ field: string, width?: number | null }> | null, sorts?: Array<{ field: string, direction: string }> | null }> } } | null };
...
export type UpdateTableViewsMutation = { updateTableViews: { version: number, defaultViewId: string, views: Array<{ id: string, name: string, description?: string | null, filters?: { [key: string]: any } | string | number | boolean | null | null, search?: string | null, columns?: Array<{ field: string, width?: number | null }> | null, sorts?: Array<{ field: string, direction: string }> | null }> } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    RemoveRow(variables: RemoveRowMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RemoveRowMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<RemoveRowMutation>(RemoveRowDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RemoveRow', 'mutation', variables);
    },
    ...
    createBranchByRevisionIdForSidebar(variables: CreateBranchByRevisionIdForSidebarMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateBranchByRevisionIdForSidebarMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateBranchByRevisionIdForSidebarMutation>(CreateBranchByRevisionIdForSidebarDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createBranchByRevisionIdForSidebar', 'mutation', variables);
    },
    removeTableForList(variables: RemoveTableForListMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RemoveTableForListMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<RemoveTableForListMutation>(RemoveTableForListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'removeTableForList', 'mutation', variables);
    },
