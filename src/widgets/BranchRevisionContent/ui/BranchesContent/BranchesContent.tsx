import { Box, Flex, Text, Separator, Spinner } from '@chakra-ui/react'
...
export const BranchesContent: FC = observer(() => {
  ...
  return (
    <Flex flexDirection="column" height="290px" width="100%" overflow="hidden">
      ...
      <Box>
        <Separator borderColor="newGray.100" my={2} />
        <Link to={model.branchesLink}>
          <Text fontSize="xs" color="newGray.400" _hover={{ color: 'newGray.600' }} textAlign="center">
            Manage branches
          </Text>
        </Link>
      </Box>
