...
export type PageInfoFragment = { startCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, endCursor?: string | null };
...
export type FindForeignKeyQuery = { rows: { totalCount: number, pageInfo: { startCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, endCursor?: string | null }, edges: Array<{ cursor: string, node: { id: string } }> } };
...
export type ConfigurationQuery = { configuration: { availableEmailSignUp: boolean, google: { available: boolean, clientId?: string | null }, github: { available: boolean, clientId?: string | null }, plugins: { file: boolean } } };

export type UserFragment = { id: string, username?: string | null, email?: string | null, organizationId?: string | null, role?: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } | null };

export type GetMeQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMeQuery = { me: { id: string, username?: string | null, email?: string | null, organizationId?: string | null, role?: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } | null } };

export type BranchMstFragment = { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } };

export type EndpointMstFragment = { id: string, type: EndpointType, createdAt: string, revisionId: string };

export type PageInfoMstFragment = { startCursor?: string | null, endCursor?: string | null, hasPreviousPage: boolean, hasNextPage: boolean };

export type PermissionMstFragment = { id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null };

export type RoleMstFragment = { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> };

export type UserProjectMstFragment = { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } };

export type UserOrganizationMstFragment = { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } };

export type ProjectMstFragment = { id: string, organizationId: string, createdAt: string, name: string, isPublic: boolean, rootBranch: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } }, userProject?: { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } } | null, organization: { id: string, userOrganization?: { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } } | null } };

export type RevisionMstFragment = { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> };

export type RevisionStartMstFragment = { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> };

export type RevisionDraftMstFragment = { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> };

export type RowMstFragment = { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, data: { [key: string]: any } | string | number | boolean | null };

export type TableMstFragment = { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null };
...
export type CreateBranchByRevisionIdMstMutation = { createBranchByRevisionId: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } } };
...
export type CreateEndpointMstMutation = { createEndpoint: { id: string, type: EndpointType, createdAt: string, revisionId: string } };
...
export type CreateProjectMstMutation = { createProject: { id: string, organizationId: string, createdAt: string, name: string, isPublic: boolean, rootBranch: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } }, userProject?: { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } } | null, organization: { id: string, userOrganization?: { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } } | null } } };
...
export type CreateRevisionMstMutation = { createRevision: { id: string, createdAt: string, comment: string, branch: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } }, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } };
...
export type CreateRowMstMutation = { createRow: { previousVersionTableId: string, table: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null }, row: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, data: { [key: string]: any } | string | number | boolean | null } } };
...
export type CreateTableMstMutation = { createTable: { branch: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } }, table: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null } } };
...
export type DeleteRowMstMutation = { removeRow: { previousVersionTableId?: string | null, branch: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } }, table?: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null } | null } };
...
export type DeleteTableMstMutation = { removeTable: { branch: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } } } };
...
export type RenameRowMstMutation = { renameRow: { previousVersionTableId: string, previousVersionRowId: string, table: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null }, row: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, data: { [key: string]: any } | string | number | boolean | null } } };
...
export type RenameTableMstMutation = { renameTable: { previousVersionTableId: string, table: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null } } };
...
export type RevertChangesMstMutation = { revertChanges: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } } };
...
export type UpdateRowMstMutation = { updateRow: { previousVersionTableId: string, previousVersionRowId: string, table: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null }, row: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, data: { [key: string]: any } | string | number | boolean | null } } };
...
export type UpdateTableMstMutation = { updateTable: { previousVersionTableId: string, table: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null } } };
...
export type BranchMstQuery = { branch: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } } };
...
export type BranchesMstQuery = { branches: { totalCount: number, pageInfo: { startCursor?: string | null, endCursor?: string | null, hasPreviousPage: boolean, hasNextPage: boolean }, edges: Array<{ cursor: string, node: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } } }> } };
...
export type MeProjectsMstQuery = { meProjects: { totalCount: number, pageInfo: { startCursor?: string | null, endCursor?: string | null, hasPreviousPage: boolean, hasNextPage: boolean }, edges: Array<{ cursor: string, node: { id: string, organizationId: string, createdAt: string, name: string, isPublic: boolean, rootBranch: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } }, userProject?: { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } } | null, organization: { id: string, userOrganization?: { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } } | null } } }> } };
...
export type ProjectMstQuery = { project: { id: string, organizationId: string, createdAt: string, name: string, isPublic: boolean, rootBranch: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } }, userProject?: { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } } | null, organization: { id: string, userOrganization?: { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } } | null } } };
...
export type ProjectsMstQuery = { projects: { totalCount: number, pageInfo: { startCursor?: string | null, endCursor?: string | null, hasPreviousPage: boolean, hasNextPage: boolean }, edges: Array<{ cursor: string, node: { id: string, organizationId: string, createdAt: string, name: string, isPublic: boolean, rootBranch: { id: string, createdAt: string, name: string, touched: boolean, projectId: string, parent?: { branch: { id: string, name: string }, revision: { id: string } } | null, start: { id: string, createdAt: string, comment: string, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, head: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> }, draft: { id: string, createdAt: string, comment: string, parent?: { id: string } | null, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } }, userProject?: { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } } | null, organization: { id: string, userOrganization?: { id: string, role: { id: string, name: string, permissions: Array<{ id: string, action: string, subject: string, condition?: { [key: string]: any } | string | number | boolean | null | null }> } } | null } } }> } };
...
export type RevisionMstQuery = { revision: { id: string, createdAt: string, comment: string, branch: { id: string }, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }>, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }> } };

export type BranchRevisionMstFragment = { id: string, createdAt: string, comment: string, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }>, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }> };
...
export type RevisionsMstQuery = { branch: { id: string, revisions: { totalCount: number, pageInfo: { startCursor?: string | null, endCursor?: string | null, hasPreviousPage: boolean, hasNextPage: boolean }, edges: Array<{ cursor: string, node: { id: string, createdAt: string, comment: string, endpoints: Array<{ id: string, type: EndpointType, createdAt: string, revisionId: string }>, parent?: { id: string } | null, child?: { id: string } | null, childBranches: Array<{ branch: { id: string, name: string }, revision: { id: string } }> } }> } } };
...
export type RowForeignKeysByQuery = { row?: { versionId: string, rowForeignKeysBy: { totalCount: number, pageInfo: { startCursor?: string | null, endCursor?: string | null, hasPreviousPage: boolean, hasNextPage: boolean }, edges: Array<{ cursor: string, node: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, data: { [key: string]: any } | string | number | boolean | null } }> } } | null };
...
export type RowMstQuery = { row?: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, data: { [key: string]: any } | string | number | boolean | null } | null };
...
export type RowsMstQuery = { rows: { totalCount: number, pageInfo: { startCursor?: string | null, endCursor?: string | null, hasPreviousPage: boolean, hasNextPage: boolean }, edges: Array<{ cursor: string, node: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, data: { [key: string]: any } | string | number | boolean | null } }> } };
...
export type TableForeignKeysByQuery = { table?: { versionId: string, foreignKeysBy: { totalCount: number, pageInfo: { startCursor?: string | null, endCursor?: string | null, hasPreviousPage: boolean, hasNextPage: boolean }, edges: Array<{ cursor: string, node: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null } }> } } | null };
...
export type TableMstQuery = { table?: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null } | null };
...
export type TablesMstQuery = { tables: { totalCount: number, pageInfo: { startCursor?: string | null, endCursor?: string | null, hasPreviousPage: boolean, hasNextPage: boolean }, edges: Array<{ cursor: string, node: { createdId: string, id: string, versionId: string, createdAt: string, updatedAt: string, readonly: boolean, count: number, schema: { [key: string]: any } | string | number | boolean | null } }> } };
...
export type FindBranchesQuery = { branches: { totalCount: number, pageInfo: { startCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, endCursor?: string | null }, edges: Array<{ cursor: string, node: { id: string, name: string, isRoot: boolean, touched: boolean, parent?: { revision: { branch: { id: string } } } | null } }> } };

export type FindRevisionFragment = { id: string, comment: string, isDraft: boolean, isHead: boolean, isStart: boolean, createdAt: string, endpoints: Array<{ id: string, type: EndpointType }> };
...
export type RowListItemFragment = { id: string, versionId: string, readonly: boolean, data: { [key: string]: any } | string | number | boolean | null };
...
export type RowListRowsQuery = { rows: { totalCount: number, pageInfo: { hasNextPage: boolean, endCursor?: string | null }, edges: Array<{ node: { id: string, versionId: string, readonly: boolean, data: { [key: string]: any } | string | number | boolean | null } }> } };
...
export type PatchRowInlineMutation = { patchRow: { row: { id: string, versionId: string, readonly: boolean, data: { [key: string]: any } | string | number | boolean | null } } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    CreateBranchByRevisionIdMst(variables: CreateBranchByRevisionIdMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateBranchByRevisionIdMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateBranchByRevisionIdMstMutation>(CreateBranchByRevisionIdMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateBranchByRevisionIdMst', 'mutation', variables);
    },
    CreateEndpointMst(variables: CreateEndpointMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateEndpointMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateEndpointMstMutation>(CreateEndpointMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateEndpointMst', 'mutation', variables);
    },
    CreateProjectMst(variables: CreateProjectMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateProjectMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateProjectMstMutation>(CreateProjectMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateProjectMst', 'mutation', variables);
    },
    CreateRevisionMst(variables: CreateRevisionMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateRevisionMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateRevisionMstMutation>(CreateRevisionMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateRevisionMst', 'mutation', variables);
    },
    CreateRowMst(variables: CreateRowMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateRowMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateRowMstMutation>(CreateRowMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateRowMst', 'mutation', variables);
    },
    CreateTableMst(variables: CreateTableMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateTableMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateTableMstMutation>(CreateTableMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateTableMst', 'mutation', variables);
    },
    DeleteEndpointMst(variables: DeleteEndpointMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteEndpointMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteEndpointMstMutation>(DeleteEndpointMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteEndpointMst', 'mutation', variables);
    },
    DeleteProjectMst(variables: DeleteProjectMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteProjectMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteProjectMstMutation>(DeleteProjectMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteProjectMst', 'mutation', variables);
    },
    DeleteRowMst(variables: DeleteRowMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteRowMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteRowMstMutation>(DeleteRowMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteRowMst', 'mutation', variables);
    },
    DeleteTableMst(variables: DeleteTableMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteTableMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteTableMstMutation>(DeleteTableMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteTableMst', 'mutation', variables);
    },
    RenameRowMst(variables: RenameRowMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RenameRowMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<RenameRowMstMutation>(RenameRowMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RenameRowMst', 'mutation', variables);
    },
    RenameTableMst(variables: RenameTableMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RenameTableMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<RenameTableMstMutation>(RenameTableMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RenameTableMst', 'mutation', variables);
    },
    RevertChangesMst(variables: RevertChangesMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RevertChangesMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<RevertChangesMstMutation>(RevertChangesMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RevertChangesMst', 'mutation', variables);
    },
    UpdateRowMst(variables: UpdateRowMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdateRowMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateRowMstMutation>(UpdateRowMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateRowMst', 'mutation', variables);
    },
    UpdateTableMst(variables: UpdateTableMstMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdateTableMstMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateTableMstMutation>(UpdateTableMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdateTableMst', 'mutation', variables);
    },
    BranchMst(variables: BranchMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<BranchMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<BranchMstQuery>(BranchMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'BranchMst', 'query', variables);
    },
    BranchesMst(variables: BranchesMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<BranchesMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<BranchesMstQuery>(BranchesMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'BranchesMst', 'query', variables);
    },
    GetRowCountForeignKeysTo(variables: GetRowCountForeignKeysToQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetRowCountForeignKeysToQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRowCountForeignKeysToQuery>(GetRowCountForeignKeysToDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetRowCountForeignKeysTo', 'query', variables);
    },
    meProjectsMst(variables: MeProjectsMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<MeProjectsMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<MeProjectsMstQuery>(MeProjectsMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'meProjectsMst', 'query', variables);
    },
    ProjectMst(variables: ProjectMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ProjectMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ProjectMstQuery>(ProjectMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'ProjectMst', 'query', variables);
    },
    ProjectsMst(variables: ProjectsMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ProjectsMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ProjectsMstQuery>(ProjectsMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'ProjectsMst', 'query', variables);
    },
    RevisionMst(variables: RevisionMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RevisionMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RevisionMstQuery>(RevisionMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RevisionMst', 'query', variables);
    },
    RevisionsMst(variables: RevisionsMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RevisionsMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RevisionsMstQuery>(RevisionsMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RevisionsMst', 'query', variables);
    },
    RowForeignKeysBy(variables: RowForeignKeysByQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RowForeignKeysByQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RowForeignKeysByQuery>(RowForeignKeysByDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RowForeignKeysBy', 'query', variables);
    },
    RowMst(variables: RowMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RowMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RowMstQuery>(RowMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RowMst', 'query', variables);
    },
    RowsMst(variables: RowsMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RowsMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RowsMstQuery>(RowsMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RowsMst', 'query', variables);
    },
    TableForeignKeysBy(variables: TableForeignKeysByQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<TableForeignKeysByQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TableForeignKeysByQuery>(TableForeignKeysByDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'TableForeignKeysBy', 'query', variables);
    },
    TableMst(variables: TableMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<TableMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TableMstQuery>(TableMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'TableMst', 'query', variables);
    },
    TablesMst(variables: TablesMstQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<TablesMstQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TablesMstQuery>(TablesMstDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'TablesMst', 'query', variables);
    },
    ...
    RemoveRows(variables: RemoveRowsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RemoveRowsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<RemoveRowsMutation>(RemoveRowsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'RemoveRows', 'mutation', variables);
    },
